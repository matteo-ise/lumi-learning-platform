...
export function HotKeyButtons({ onHotkey, disabled, currentStep = 1, mode = 'chat', examState = 'idle' }: Props) {
  const isFinalStep = currentStep === 3

  let hotkeys: { type: string; label: string; emoji: string; color: string }[]
